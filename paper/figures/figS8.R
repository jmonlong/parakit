...
pdf('figS8.raw.pdf', 7, 6)
plot_grid(ggp$reads_DEN63360 + ggp.xlims + nox + nobg + vlines,
          ggp$cov_DEN63360 + ggp.xlims + nox + nobg + noleg + vlines,
          ggp$as_DEN63360 + ggp.xlims + nox + nobg + noleg + vlines,
          ggp$hap_DEN63360 + ggp.xlims + nox + nobg + noleg + vlines,
