...
samples = c('DEN63290', 'DEN63291', 'DEN63292')
...
pdf('figS6.raw.pdf', 7, 8)
plot_grid(ggp$reads_DEN63290 + ggp.xlims + nox + nobg + vlines,
          ggp$cov_DEN63290 + ggp.xlims + nox + nobg + noleg + vlines,
          ggp$as_DEN63290 + ggp.xlims + nox + nobg + noleg + vlines,
          ggp$hap_DEN63290 + ggp.xlims + nox + nobg + noleg + vlines,
          ggp$hap_DEN63291 + ggp.xlims + nox + nobg + noleg + vlines,
          ggp$hap_DEN63292 + ggp.xlims + nox + nobg + noleg + vlines,
          ggp$genes + ggp.xlims + noleg + nobg + vlines,
          ncol=1, align='v', rel_heights=c(3,1.5,1.5,1.5,1.5,1.5,3))
dev.off()
